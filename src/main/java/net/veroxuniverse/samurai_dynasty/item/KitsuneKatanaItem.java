...
public class KitsuneKatanaItem extends ESWeaponItem {
    public KitsuneKatanaItem(ToolMaterial pTier, float pAttackDamage, float pAttackSpeed, Properties pProperties) {
