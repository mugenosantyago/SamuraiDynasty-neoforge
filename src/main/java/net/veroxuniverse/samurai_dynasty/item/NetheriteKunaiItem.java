...
public class NetheriteKunaiItem extends ESWeaponItem {
    ...
    public NetheriteKunaiItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Properties settings) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull Item.TooltipContext context, @NotNull TooltipDisplay tooltipDisplay, @NotNull Consumer<Component> components, @NotNull TooltipFlag flag) {
        ...
        components.accept(Component.literal(" 8+ Ranged Damage").withStyle(ChatFormatting.DARK_GREEN));
    }
}
