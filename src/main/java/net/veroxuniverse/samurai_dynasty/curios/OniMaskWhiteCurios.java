...
public class OniMaskWhiteCurios extends Item {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag flag) {
        if(Screen.hasShiftDown() && stack.getItem() == ItemsRegistry.ONI_MASK_WHITE.get()) {
            components.add(Component.translatable("curios.samurai_dynasty.summary"));
            components.add(Component.literal(""));
            components.add(Component.translatable("curios.samurai_dynasty.resistance").withStyle(ChatFormatting.GRAY));
        ...
        } else if (stack.getItem() == ItemsRegistry.ONI_MASK_WHITE.get()) {
            components.add(Component.translatable("curios.samurai_dynasty.summary"));
        }
